    ...
    const servicios = [
      {
        ...
        imagen: '/src/assets/DISTRIBUCION_NACIONAL.jpg', // Asegúrate de tener esta imagen en public/assets/
      },
      {
